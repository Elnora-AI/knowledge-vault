...
- LLM formatting, if enabled, uses your own `OPENROUTER_API_KEY` (or an equivalent you configure) via environment variables — never committed, never logged. A connector `env_file` keeps keys in a file you control.
